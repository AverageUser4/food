...
<body>
  ...
  <main class="the-main">
    ...
    <div class="carousel">
      <div class="carousel__content">
        <a class="carousel__link">Top 100 Recipes For Kids</a>
      </div>
    </div>

    <section class="the-main-first-section">

      <div class="first-section__top-links-and-whats-fresh-container">

        <div class="first-section__top-links-container">
          ...
          <a class="first-section__top-link first-section__top-link-third">
      ...
      <div class="first-section__bottom-links-container">
    ...
    <div class="cool-sections-container">
      ...
      <section class="section-type-1">
        ...
        <div class="section-type-1__content-container">
          ...
          <article class="section-type-1__article section-type-1__fifth-article">
      ...
      <section class="section-type-2">
        ...
        <div class="section-type-2__content-container">
          ...
          <article class="section-type-2__article">
            ...
            <a class="section-type-2__article-link">
              <img class="section-type-2__article-image section-type-2__article-image-2" src="resources/images/misc/big-article.jpg">
              <span class="section-type-2__article-span">Photos</span>
              <h4 class="section-type-2__article-heading">40 Quick Chicken Ideas</h4>
            </a>
      ...
      <section class="section-type-2 section-type-2-last">
        ...
        <div class="section-type-2__content-container">
          ...
          <article class="section-type-2__article">
            ...
            <a class="section-type-2__article-link">
              <img class="section-type-2__article-image section-type-2__article-image-2" src="resources/images/misc/big-article-2.jpg">
              <span class="section-type-2__article-span">Photos</span>
              <h4 class="section-type-2__article-heading">Kids & Family</h4>
            </a>
  ...
  <footer class="the-footer">
    ...
    <nav class="the-footer__nav">
      ...
      <div class="the-footer__nav-first-part">

        <div class="the-footer_back-button-and-social-ul">
      ...
      <div class="the-footer__nav-second-part">
